    ...
    pub fn strings(self) -> UiTextSnapshot {
        match self {
            AppLanguage::English => UiTextSnapshot {
                ...
                enable_animations_detail: "Animate UI transitions for a smoother feel".to_string(),
                cursor_glide: "Cursor Glide".to_string(),
                cursor_glide_detail: "Smooth cursor movement between positions".to_string(),
                smooth_scroll: "Smooth Scrolling".to_string(),
                smooth_scroll_detail: "Animate viewport when scrolling".to_string(),
                cursor_trail: "Cursor Trail".to_string(),
                cursor_trail_detail: "Show subtle ghost cursors behind the active cursor".to_string(),
            ...
            AppLanguage::Spanish => UiTextSnapshot {
                ...
                enable_animations_detail: "Animar transiciones de la interfaz para mayor fluidez".to_string(),
                cursor_glide: "Deslizamiento del Cursor".to_string(),
                cursor_glide_detail: "Movimiento suave del cursor entre posiciones".to_string(),
                smooth_scroll: "Desplazamiento Suave".to_string(),
                smooth_scroll_detail: "Animar la vista al desplazarse".to_string(),
                cursor_trail: "Estela del Cursor".to_string(),
                cursor_trail_detail: "Mostrar cursores fantasma sutiles detrás del cursor activo".to_string(),
            ...
            AppLanguage::Japanese => UiTextSnapshot {
                ...
                enable_animations_detail: "UI の遷移をアニメーションで滑らかにする".to_string(),
                cursor_glide: "カーソルグライド".to_string(),
                cursor_glide_detail: "カーソル移動を滑らかに補間する".to_string(),
                smooth_scroll: "スムーズスクロール".to_string(),
                smooth_scroll_detail: "スクロール時にビューポートをアニメーションする".to_string(),
                cursor_trail: "カーソル軌跡".to_string(),
                cursor_trail_detail: "アクティブカーソルの後ろに薄いゴーストカーソルを表示する".to_string(),
...
pub struct UiTextSnapshot {
    ...
    pub visual_section: String,
    pub use_mica: String,
    pub use_mica_detail: String,
    pub enable_animations: String,
    pub enable_animations_detail: String,
    pub cursor_glide: String,
    pub cursor_glide_detail: String,
    pub smooth_scroll: String,
    pub smooth_scroll_detail: String,
    pub cursor_trail: String,
    pub cursor_trail_detail: String,
