...
- If a settings/sidebar item looks like navigation, make it actually switch local Slint presentation state or remove the affordance. Decorative nav rails and inert header actions are worse than a plain scrolling form.
